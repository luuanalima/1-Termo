...
janela.mainloop()
>>>>>>> 60a30622c2800ba91a827973897f909c8154ce98:formativas/prova.py
...
# btn_valida = tk.Button(janela, text="Cadastrar Usuário", bg="black", fg="white", width=30, command=medida_validacao)
